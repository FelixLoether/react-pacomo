...
function transformWithPrefix(prefix) {
  ...
  function transform(element, rootClass) {
    ...
    if ((typeof element === 'undefined' ? 'undefined' : _typeof(element)) !== 'object' || element.props.__pacomoSkip) return element;
    ...
    decorator: function decorator(componentClass) {
      ...
      var DecoratedComponent = function (_componentClass) {
        ...
        function DecoratedComponent() {
          ...
          return _possibleConstructorReturn(this, Object.getPrototypeOf(DecoratedComponent).apply(this, arguments));
        }
      ...
      // Add `className` propType, if none exists
      DecoratedComponent.propTypes = _extends({ className: _react.PropTypes.string }, componentClass.propTypes);
